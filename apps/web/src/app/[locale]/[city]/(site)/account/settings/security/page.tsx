...
export default function SecuritySettingsPage() {
  ...
  // Fetch user accounts to check if user has credential account
  ...
  // Check if user has a credential account (can change password)
  const hasCredentialAccount = accountsData?.some((account) => account.providerId === 'credential');
  ...
  const currentSessionToken =
    typeof window !== 'undefined' ? document.cookie.match(/better-auth\.session[^=]*=([^;]*)/)?.[1] : null;
          ...
          <div className='flex items-center justify-between'>
            <div className='flex items-center gap-3'>
              ...
              <div>
                ...
                <CardDescription className='text-sm'>Devices where you're currently signed in</CardDescription>
              </div>
            </div>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent className='rounded-2xl'>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This will sign you out of all devices except the current one. You'll need to sign in again on
                      those devices.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
        ...
        <CardContent>
          <ul className='space-y-3'>
            ...
            <li className='flex items-start gap-3'>
              ...
              <p className='text-sm text-muted-foreground'>Keep your email address up to date for account recovery</p>
            </li>
          </ul>
        </CardContent>
      </Card>
