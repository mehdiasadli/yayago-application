...
function AutocompleteGroup({ className, ...props }: AutocompletePrimitive.Group.Props) {
  return <AutocompletePrimitive.Group data-slot='autocomplete-group' className={className} {...props} />;
}
...
function AutocompleteRow({ className, ...props }: AutocompletePrimitive.Row.Props) {
  return <AutocompletePrimitive.Row data-slot='autocomplete-row' className={className} {...props} />;
}
...
function AutocompleteTrigger({ className, ...props }: AutocompletePrimitive.Trigger.Props) {
  return <AutocompletePrimitive.Trigger data-slot='autocomplete-trigger' className={className} {...props} />;
}
