    ...
    return (
      <div className='container mx-auto px-4 py-16'>
        <div className='max-w-md mx-auto text-center'>
          <User className='size-16 mx-auto mb-4 text-muted-foreground' />
          <h1 className='text-2xl font-bold mb-2'>Sign In Required</h1>
          <p className='text-muted-foreground mb-6'>Please sign in to view your booking details.</p>
          <Button asChild>
          ...
          <div className='flex items-center gap-4'>
            ...
            <div>
              <div className='flex items-center gap-3'>
                <h1 className='text-2xl font-bold font-mono'>{booking.referenceCode}</h1>
              ...
              <CardContent className='space-y-6'>
                <div className='flex items-start gap-4 p-4 bg-muted/50 rounded-lg'>
                  {booking.listing.primaryImage ? (
                    ...
                    <div className='size-24 sm:size-32 rounded-lg bg-muted flex items-center justify-center'>
